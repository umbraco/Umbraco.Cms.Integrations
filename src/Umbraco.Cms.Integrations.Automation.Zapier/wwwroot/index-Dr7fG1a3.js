...
var I = (e, r, t) => r in e ? U(e, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[r] = t;
...
const T = {
  ...
  name: "Zapier Context",
  js: () => import("./zapier.context-Cl9nWOQ7.js")
}, A = T, z = [
  {
    type: "dashboard",
    alias: "Zapier.Management.Dashboard",
    name: "Zapier Management Dashboard",
    element: () => import("./zapier-management-dashboard.element-Cjkxw8Gi.js"),
    weight: 5,
    meta: {
...
var W = async (e, r) => {
...
}, C = ({ allowReserved: e, explode: r, name: t, style: s, value: o, valueOnly: l }) => {
  ...
  let n = H(s), a = Object.entries(o).map(([i, f]) => g({ allowReserved: e, name: s === "deepObject" ? `${t}[${i}]` : i, value: f })).join(n);
  ...
  if (s) for (let o of s) {
    ...
    if (typeof i == "object") {
      t = t.replace(o, C({ explode: l, name: n, style: a, value: i, valueOnly: !0 }));
      continue;
    }
    if (a === "matrix") {
  ...
  return t;
}, $ = ({ allowReserved: e, array: r, object: t } = {}) => (s) => {
  let o = [];
  if (s && typeof s == "object") for (let l in s) {
    ...
    if (n != null) if (Array.isArray(n)) {
      ...
      let a = C({ allowReserved: e, explode: !0, name: l, style: "deepObject", value: n, ...t });
      a && o.push(a);
    } else {
...
}, x = (e) => Z({ baseUrl: e.baseUrl, path: e.path, query: e.query, querySerializer: typeof e.querySerializer == "function" ? e.querySerializer : $(e.querySerializer), url: e.url }), Z = ({ baseUrl: e, path: r, query: t, querySerializer: s, url: o }) => {
...
}, L = () => ({ error: new w(), request: new w(), response: new w() }), V = $({ allowReserved: !1, array: { explode: !0, style: "form" }, object: { explode: !0, style: "deepObject" } }), G = { "Content-Type": "application/json" }, q = (e = {}) => ({ ...D, headers: G, parseAs: "auto", querySerializer: V, ...e }), F = (e = {}) => {
  let r = j(q(), e), t = () => ({ ...r }), s = (n) => (r = j(r, n), t()), o = L(), l = async (n) => {
...
//# sourceMappingURL=index-Dr7fG1a3.js.map
