...
export type OauthResponse = string;

export type $OpenApiTs = {
    '/dynamics/management/api/v1/forms': {
        get: {
            req: GetFormsData;
            res: {
                /**
    ...
    '/dynamics/management/api/v1/forms/authorization-url': {
        get: {
            res: {
                /**
                 * OK
    ...
    '/umbraco/dynamics/management/api/v1/authorization': {
        get: {
            req: OauthData;
            res: {
                /**
