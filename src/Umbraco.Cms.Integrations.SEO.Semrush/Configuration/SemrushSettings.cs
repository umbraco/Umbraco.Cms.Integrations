...
namespace Umbraco.Cms.Integrations.SEO.Semrush.Configuration
{
    public class SemrushSettings
    {
        ...
        //public static string SemrushBaseAddress = "";
        ...
        public static string SemrushKeywordsEndpoint = "https://oauth.semrush.com/api/v1/keywords/{0}?access_token={1}&phrase={2}&database={3}";
