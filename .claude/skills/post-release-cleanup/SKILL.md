...
on the v18 line the `.0.0` tags went missing entirely and had to be backfilled,
and it happened again on `2026.08.3`/`2026.08.4`, where the cleanup had to stop
because no tags existed. A step owned by neither skill is a step nobody does, so
this skill owns it now.
...
```
No release-manifest.json on v17/release/2026.08.1.
...
Then:
  ...
  2. merge v17/release/2026.08.1 -> main-v17
  3. merge v17/release/2026.08.1 -> v17/dev
  4. bump on v17/dev: 7.1.0 -> 7.1.1, 9.0.2 -> 9.0.3
...
for b in origin/main-v17 origin/v17/dev; do
